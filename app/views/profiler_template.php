...
#ci-profiler-menu a{display:inline-block;font-size:12px;font-weight:600;line-height:25px;padding:3px 7px;color:#fff;text-decoration:none;cursor:pointer;}
...
<div id="codeigniter-profiler">
    <div id="ci-profiler-menu">
        ...
        <a href="#ci-profiler-memory" id="ci-profiler-menu-memory" onclick="ci_profiler_bar.show('ci-profiler-memory', 'ci-profiler-menu-memory'); return false;">
            Memory Used
            <span><?php echo function_exists('memory_get_usage') ? (round(memory_get_usage()/1024/1024, 2) . ' ' . 'mb') : '0'; ?></span>
        </a>
        <?php
            endif;
    ...
    <div id="profiler-panel">
        ...
        <p class="ci-profiler-box"><?php echo 'No profiles'; ?></p>
        <?php
        else :
            if (isset($sections['console'])) :
        ?>
